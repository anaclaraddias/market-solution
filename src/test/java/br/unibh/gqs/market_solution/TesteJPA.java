...
public class TesteJPA {
  ...
  @Test
  public void test06() {
    Cliente cliente = new Cliente("11122233344", "testinho", "ouro");
    Cliente clienteSalvo = clienteRepository.save(cliente);
    assertNotNull(clienteSalvo.getId());
    CarrinhoCompra c = new CarrinhoCompra();
    c.setCliente(clienteSalvo);
    ...
    assertEquals(247.0, c.getTotalComDesconto().intValue());
  }

  @Test
  public void test07() {
    Cliente cliente = new Cliente("11122233344", "testinho", "prata");
    Cliente clienteSalvo = clienteRepository.save(cliente);
    assertNotNull(clienteSalvo.getId()); 
  ...
  @Test
  public void test08() {
    Produto produto = new Produto("Saboroso burger com bacon e cheddar congelado", BigDecimal.valueOf(7.99), null);
  ...
  @Test
  public void teste09(){
    Cliente cliente = new Cliente("11122233344", "testinho", "bronze");
    Cliente clienteSalvo = clienteRepository.save(cliente);
    
    cliente.setNomePesquisa("testinho");
    assertNotNull(clienteSalvo.getId());
